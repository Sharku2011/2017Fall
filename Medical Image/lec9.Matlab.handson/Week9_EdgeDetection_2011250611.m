...
% SobelImgs{1,3} = filter2(sobel_h,img); %sobel_horizontal
% SobelImgs{1,4} = filter2(-sobel_h, img); %sobel_inverse horizontal
% SobelImgs{1,5} = abs(SobelImgs{1,1}); %sobel_vertical absolute
% SobelImgs{1,6} = abs(SobelImgs{1,3}); %sobel_horizontal absolute
% 
NameTag = {'sobel/vertical', 'sobel/inverse vertical', 'sobel/horizontal', ...
    'sobel/inverse horizontal', 'sobel/vertical absolute', 'sobel/horizontal absolute'};
% 
...
% subplot(1,2,2), imshow(SobelImgs{1,5}+SobelImgs{1,6}), title('sobel', 'fontsize', 14);
...
% SobelImgs{2,3} = filter2(sobel_h,img_aver);
% SobelImgs{2,4} = filter2(-sobel_h, img_aver);
% SobelImgs{2,5} = abs(SobelImgs{2,1});
% SobelImgs{2,6} = abs(SobelImgs{2,3});
% 
% 
...
% subplot(1,2,2), imshow(SobelImgs{2,5}+SobelImgs{2,6}), title('sobel', 'fontsize', 14);
% 
